...
namespace Milles_Project1.Menus.Calculator
{
    ...
    {
        public static void ShowCalculatorMenu(IContainer container)
        {
            using (var scope = container.BeginLifetimeScope())
            {
                var calculator = scope.Resolve<ICalculatorContext>();
                int choice;
        ...
        private static void PerformCalculation(ICalculatorContext calculator)
        {
